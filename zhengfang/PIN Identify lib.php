...
function discern( $letter1 , $letter2 , $letter3 , $letter4 )//识别
{
    ...
    $link = mysqli_connect( 'db-2shmki52o.aliwebs.com' , '2shmki52o' , '11zz23456' , '2shmki52o');
    if (!$link)
    {
   ...
   // echo $z . '***' . $str . '<br/>';
    $_SESSION["letteri"] = substr($str,-1,1);
//    echo $str.' ';
  ...
  //  echo $z . '***' . $str . '<br/>';
//    echo $str.' ';
    $_SESSION["letterii"] = substr($str,-1,1);
  ...
  //  echo $z . '***' . $str . '<br/>';
//    echo $str.' ';
    $_SESSION["letteriii"] = substr($str,-1,1);
   ...
   // echo $z . '***' . $str . '<br/>';
   // echo '</div>';
     $_SESSION["letteriv"] = substr($str,-1,1);
